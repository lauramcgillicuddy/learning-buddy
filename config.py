...
Be encouraging but honest. Keep responses concise — this may be a voice conversation.\
"""

# Can be overridden by the user via the UI or PERSONALITY_PROMPT env var
PERSONALITY_PROMPT = os.getenv("PERSONALITY_PROMPT", _DEFAULT_PERSONALITY)

SYSTEM_PROMPT = PERSONALITY_PROMPT  # alias used by ai/client.py

QUIZ_DIFFICULTY = os.getenv("QUIZ_DIFFICULTY", "standard")  # friendly | standard | viva
